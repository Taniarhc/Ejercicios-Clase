...
//La serie a programar de KeyFRAMES es la sigiente PoztBjOZTbojtBTbgozTbgOZg
#include "texture.h"
#include "figuras.h"
#include "Camera.h"
...
void interpolation ( void )
{
	...
	KeyFrame[playIndex].rotInc = (KeyFrame[playIndex + 1].rotBrazoIzq - KeyFrame[playIndex].rotBrazoIzq) / i_max_steps;
...
void monito()
{
	...
	glPushMatrix();//Pecho
		...
		glPushMatrix(); //Brazo derecho-->
			...
			glRotatef(15 + rotBrazoDer, 1, 0, 0);
		...
		glPushMatrix(); //Brazo izquierdo <--
			glTranslatef(-1.25, 0.65, 0);
			glRotatef(15 + rotBrazoIzq, 1, 0, 0);
			fig7.esfera(0.5, 12, 12, 0);
			glPushMatrix();
				glTranslatef(-0.25, 0, 0);
				glRotatef(45, 0, 1, 0); 
...
void animacion()
{
	...
	{		
		...
		else
		{
			...
			rotBrazoIzq += KeyFrame[playIndex].rotInc;
